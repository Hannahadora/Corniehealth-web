          ...
          >
            ...
            <div class="my-4 p-4 bg-cblue-100">
              ...
              <div class="my-8 py-4">
                <div class="flex items-center justify-between">
                  <div
                    class="tab-header"
                    :class="{ 'active-tab': activeTab === 'Enter Information' }"
                    @click="handleActiveTab('Enter Information')"
                  >
                    Enter Information
                  </div>
                  <div
                    class="tab-header"
                    :class="{ 'active-tab': activeTab === 'Verify Email & Set Password' }"
                    @click="handleActiveTab('Verify Email & Set Password')"
                  >
                    Verify Email & Set Password
                  </div>
                  <div
                    class="tab-header"
                    :class="{ 'active-tab': activeTab === ' Access Dashboard' }"
                    @click="handleActiveTab('Access Dashboard')"
                  >
                     Access Dashboard
                  </div>
                </div>
            ...
            <div class="my-6 w-full text-center">
              ...
              <span
                ...
                @click="$router.push('/book-appointment/login')"
                >Sign in</span
              >
            </div>
