<template>
  <div>
    ...
    <div
      class="w-full flex xl:grid xl:grid-cols-2 grid-cols-1 gap-8 items-start mb-12"
    >
      <div class="info-container xl:p-6 p-4">
        <div class="w-full xl:border-b-0 border-b xl:pb-0 pb-8">
