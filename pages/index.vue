  ...
  <div class>
    ...
    <div class="mt-12 pt-14">
      <div class="text-center xl:w-1/2 lg:w-2/3 w-9/12 mx-auto">
        ...
        <p class="mt-5">
          We empower you and your loved ones with secure access to your health
          records and the needed control to better manage your health
        </p>
      </div>
      <div class="c-wrapper mt-16 b-2">
        ...
        >
          ...
          <img
            class="lg:h-full lg:w-1/2 w-full"
            src="/images/image 23.svg"
            alt=""
          />
        </div>
        <div class="grid grid-cols-4 text-white bg-razzmataz-pry mt-16 py-3">
    ...
    <div class="mt-20">
      <div class="text-center w-1/2 mx-auto mb-2">
      ...
      <div
        class="mt-24 xl:mx-56 lg:mx-32 mx-11 circ-grid grid lg:items-center items-start lg:grid-rows-2 grid-rows-3 lg:grid-cols-4 grid-cols-2 lg:gap-x-3 gap-x-20 xl:gap-y-32 lg:gap-y-3 gap-y-10"
      >
        <div class="flex flex-col items-end justify-end order-1 lg:self-auto self-end">
          <img class="lg:self-auto self-start lg:w-36 w-16" src="/images/Medical prescription-pana 1.svg" alt="" />
          <div
            class="flex lg:flex-row flex-col lg:items-center items-end gap-5"
          >
            <h4 class="lg:block hidden">4. Manage your health records</h4>
            <h4 class="lg:hidden block">4. Access records</h4>
            <img
              src="/images/plus-circle.svg"
              class="lg:w-10 w-7 lg:h-10 h-7"
              alt=""
            />
          </div>
        </div>
        ...
        <img
          class="col-span-2 lg:row-span-2 lg:order-2 order-3"
          src="/images/img-center.svg"
          alt=""
        />

        <div class="flex flex-col items-start justify-start lg:order-3 order-2 lg:self-auto self-end">
          <img
            class="lg:hidden block self-end w-16"
            src="/images/Mobile login-pana.svg"
            alt=""
          />
          <div
            class="flex lg:flex-row flex-col flex-col-reverse lg:items-center items-start gap-5"
          >
            <img
              src="/images/plus-circle.svg"
              class="lg:w-10 w-7 lg:h-10 h-7"
        ...
        <div class="flex flex-col items-center justify-end order-4">
          <div class="flex lg:flex-row flex-col flex-col-reverse lg:items-center items-end gap-5">
            <h4 class="lg:block hidden">3. Access Quality Care</h4>
            <h4 class="lg:hidden block">3. Visit</h4>
            <img
              src="/images/plus-circle.svg"
              class="lg:w-10 w-7 lg:h-10 h-7"
              alt=""
          ...
          <img class="lg:self-auto self-end lg:w-36 w-16" src="/images/Medical care-rafiki 1.svg" alt="" />
        </div>
        ...
        <div class="flex flex-col items-start justify-start order-5">
          <div class="flex lg:flex-row flex-col items-center gap-5">
            <img
              ...
              alt=""
            />
            <h4 class="lg:block hidden">2. Explore & Engage</h4>
            <h4 class="lg:hidden block">2. Search</h4>
          </div>
          <img
            class="lg:self-auto self-start lg:w-36 w-16"
            src="/images/explore-engage.svg"
            alt=""
          />
        </div>
      </div>
    ...
    <div class="c-wrapper mt-40">
      <div class="text-center xl:w-1/2 lg:w-2/3 mx-auto mb-6">
        <h2 class="c-indigo">It’s your health, make better choices</h2>
        <p>
          Sign Up to the CornieCare App and enjoy better healthcare outcomes.
          Engage with doctors, shop medicines, book diagnostic tests, available
          24/7
      ...
      <div class="my-12 mx-6 grid xl:grid-cols-4 lg:grid-cols-3 gap-2">
        <div
          v-for="(choice, index) in choices"
          :key="index"
          class="py-12 px-6"
          :class="{ 'bg-razzmataz-pry rounded-lg text-white': choice.active }"
        >
    ...
    <div class="text-center xl:w-1/2 lg:w-2/3 w-9/12 mx-auto mt-9 pt-20 mb-32">
      <h2 class="c-indigo mb-4">Take charge of your health, today.</h2>
      <p class="mb-4">
        Sign Up to the CornieCare App and enjoy better healthcare outcomes.
        Engage with doctors, shop medicines, book diagnostic tests, available
        24/7
...
<style scoped>
	...
	@media screen and (max-width: 768px) {
		.circ-grid {
		grid-template-rows: 3(0, 25%, 50%, 25%);
		grid-template-columns: 4(0, 1fr);
	}
	}
	</style>
