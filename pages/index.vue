<template>
	<div class>
		...
		<div class="mt-20">
          ...
          lg:mx-32
		  mx-11
          grid lg:grid-rows-2 grid-rows-4 lg:grid-cols-4 grid-cols-2
          lg:gap-x-3
		  gap-x-20
          xl:gap-y-32
          lg:gap-y-3
        ...
        "
			>
				<div class="flex flex-col items-end justify-end order-1">
				...
				<div class="flex flex-col items-start justify-start lg:order-3 order-2">
					<div class="flex items-center gap-5">
						<img src="/images/plus-circle.svg" alt="" />
						<h4>1. Sign up</h4>
					</div>
					<img src="/images/Mobile login-pana.svg" alt="" />
				</div>
				...
				<div class="flex flex-col items-start justify-start order-5">
					...
					<img src="/images/explore-engage.svg" alt="" />
				</div>
			</div>
		</div>
