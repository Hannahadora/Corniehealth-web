<template>
	<div class="">
		...
		<div v-if="insuranceprovider === 'employer' && haveInsurance === 'yes'" class="w-1/2 mx-auto my-8">
		...
		<div v-if="insuranceprovider === 'private' && haveInsurance === 'yes'" class="text-center">
			...
			<form action="" class="w-1/2 mx-auto mt-8">
				<cornie-select label="Insurance Carrier"> </cornie-select>
			</form>
		</div>

		<div class="w-2/3 mx-auto mt-12 flex items-cente justify-center">
			<c-button
				class="w-1/2 mr-6"
				type="button"
				:primary="true"
...
@Component({
  components: { CButton, CornieInput, CornieSelect },
